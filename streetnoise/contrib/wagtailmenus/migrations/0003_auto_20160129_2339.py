    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                help_text="If supplied, appears above the menu when rendered.", max_length=255, blank=True
            ),
        ),
        migrations.AlterField(
            ...
            name="link_text",
            field=models.CharField(
                help_text="If left blank, the page title will be used. Must be set if you wish to link to a custom URL.",
                max_length=255,
                blank=True,
            ),
        ),
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                help_text="e.g. Overview. If left blank, the page title will be used.",
                max_length=255,
                verbose_name="Link text for sub-menu item",
                blank=True,
            ),
        ),
        migrations.AlterField(
