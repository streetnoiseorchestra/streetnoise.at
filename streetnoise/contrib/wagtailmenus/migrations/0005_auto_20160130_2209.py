    ...
    operations = [
        migrations.AddField(
            ...
            field=models.CharField(
                help_text="e.g. '?abc=xyz' or '#tab-contact'",
                max_length=255,
                verbose_name="hash or querystring to append to URL",
                blank=True,
            ),
        ),
        migrations.AddField(
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                help_text="e.g. 'Overview' or 'Section home'. If left blank, the page title will be used.",
                max_length=255,
